...
TVar goblinLPSolver::PricePrimal()
    throw(ERRejected)
{
    OpenFold(ModLpPricing,NO_INDENT);
    ...
    for (TVar j=0;j<lAct;j++)
    {
           ...
           )
        {
            ...
            CloseFold(ModLpPricing,NO_INDENT);
    ...
    throw(ERRejected)
{
    ...
    CloseFold(ModLpQTest,NO_INDENT);
    ...
    throw()
{
    ...
    InitProgressCounter(50,PROGRESS_WRAP_AROUND);
    ...
    throw()
{
    ...
    CloseFold(ModLpSolve,NO_INDENT);
