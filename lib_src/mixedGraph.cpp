...
{
    X.SetCapacity(G.N()+G.NI(),G.M()+G.NI());

    TIndex* originalNode = (options & OPT_MAPPINGS) ? new TNode[G.N()+G.NI()] : NULL;
    TIndex* originalArc  = (options & OPT_MAPPINGS) ? new TArc[G.M()+G.NI()]  : NULL;
