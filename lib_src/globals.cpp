...
void* UndefinedVoidPtr(TBaseType _type) throw()
{
    ...
    switch (_type)
    {
        ...
        case TYPE_STRING      : return (void*)(&NoPointer);
...
long unsigned goblinHeapSize   = 0;
long unsigned goblinMaxSize   = 0;
long unsigned goblinNFragments = 0;
long unsigned goblinNAllocs   = 0;
long unsigned goblinNObjects  = 0;
