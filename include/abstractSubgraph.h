...
public:
    ...
    //provisorisch:
    virtual graph*  CreateGraphObject() const throw();
...
//:    TNode           NI() throw() {return ni;};
    virtual TArc    M() const throw() = 0;     //!<returns the number of edges
    virtual unsigned long   Size() const throw() {return 0;};
    virtual unsigned long   Allocated() const throw() {return 0;};
