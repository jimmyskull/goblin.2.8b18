...
class biGraph : public abstractBiGraph
{
protected:
...
public:
    ...
    biGraph(TNode _n1=0,TNode _n2=0,goblinController& _CT=goblinDefaultContext) throw();

    /// \brief  File constructor for sparse bigraphs
    ///
    /// \param fileName  The source file name
    /// \param _CT       The context to which this graph object is attached
    biGraph(const char* fileName,goblinController& _CT=goblinDefaultContext)
    ...
    virtual objectType ClassID() const throw() {return IDSparseBiGraph;};
