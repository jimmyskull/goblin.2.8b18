...
goblinGLPKWrapper::goblinGLPKWrapper(TRestr k,TVar l,TIndex nz,TObjectSense dir,
    goblinController& CT) throw()  : goblinILPWrapper(CT)
{
    lp = lpx_create_prob();
...
goblinGLPKWrapper::goblinGLPKWrapper(const char* impFileName,
    goblinController& thisContext) throw(ERFile,ERParse) :
    goblinILPWrapper(thisContext)
{
    lp=lpx_create_prob();
    lpx_set_class(lp,LPX_MIP);
    index = NULL;
    ...
    goblinILPWrapper::ReadMPSFile(F.Stream());

    InitBasis();

    goblinILPWrapper::ReadBASFile(F.Stream());
...
goblinGLPKWrapper::~goblinGLPKWrapper() throw()
{
...
void goblinGLPKWrapper::ReadMPSFile(char* file) throw()
{
    lp=lpx_read_mps(file);
}


void goblinGLPKWrapper::ReadCPLEX_LP(char* file) throw()
{
    lp = lpx_read_lpt(file);
}


void goblinGLPKWrapper::ReadGNU_MP_Model(char* model,char* data,char* output)
    throw()
{
...
void goblinGLPKWrapper::ReadBASFile(char* file) throw(ERParse,ERRejected)
{
    if (lp) lpx_read_bas(lp,file);
}


void goblinGLPKWrapper::WriteMPSFile(char* file,TLPFormat)
...
void goblinGLPKWrapper::WriteCPLEX_LP(char* file) const throw()
{
    if (lp) lpx_write_lpt(lp,file);
}


void goblinGLPKWrapper::WriteBASFile(char* file,TLPFormat)
    const throw(ERFile,ERRejected)
{
...
void goblinGLPKWrapper::WriteSimplexSolution(char* file) const throw()
{
...
TVar goblinGLPKWrapper::AddVar(TFloat lb,TFloat ub,TFloat cost,TVarType type)
    throw(ERRejected)
{
    ReleaseVarValues();
...
TRestr goblinGLPKWrapper::AddRestr(TFloat lb,TFloat ub) throw(ERRejected)
{
    lpx_add_rows(lp,1);
...
void goblinGLPKWrapper::DeleteVar(TVar j) throw(ERRange,ERRejected)
{
...
void goblinGLPKWrapper::DeleteRestr(TRestr i) throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetLRange(TVar i,TFloat lb) throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetURange(TVar i,TFloat ub) throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetUBound(TRestr i,TFloat ub) throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetLBound(TRestr i,TFloat lb) throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetCost(TVar var,TFloat cost) throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetVarType(TVar var,TVarType type) throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetVarLabel(TVar var,char* name,TOwnership own)
...
void goblinGLPKWrapper::SetRestrLabel(TRestr row,char* name,TOwnership own) 
   throw(ERRange,ERRejected)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetObjectSense(TObjectSense dir) throw() 
{
...
void goblinGLPKWrapper::SetRow(TRestr i,TVar len,TVar* index,double* val)
    throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetColumn(TVar j,TRestr len,TRestr* index,double* val)
    throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetCoeff(TRestr i,TVar j,TFloat aa)
    throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TRestr goblinGLPKWrapper::K() const throw() 
{
    return lpx_get_num_rows(lp);
}


TVar goblinGLPKWrapper::L() const throw() 
{
    return lpx_get_num_cols(lp);
}


TIndex goblinGLPKWrapper::NZ() const throw() 
{
    return lpx_get_num_nz(lp);
}


TFloat goblinGLPKWrapper::Cost(TVar j) const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TVar goblinGLPKWrapper::GetRow(TRestr i,TRestr* index,double* val)
    const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TRestr goblinGLPKWrapper::GetColumn(TVar i,TRestr* index,double* val)
    const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TFloat goblinGLPKWrapper::LRange(TVar i) const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TFloat goblinGLPKWrapper::URange(TVar i) const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TFloat goblinGLPKWrapper::LBound(TRestr i) const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TFloat goblinGLPKWrapper::UBound(TRestr i) const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
goblinGLPKWrapper::TVarType goblinGLPKWrapper::VarType(TVar i) const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
char* goblinGLPKWrapper::VarLabel(TVar i,TOwnership tp) const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
char* goblinGLPKWrapper::RestrLabel(TRestr i,TOwnership tp) const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
goblinGLPKWrapper::TObjectSense goblinGLPKWrapper::ObjectSense() const throw() 
{
    return objSense;
    /*
...
TFloat goblinGLPKWrapper::Coeff(TRestr i,TVar j)
    const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
goblinGLPKWrapper::TRestrType goblinGLPKWrapper::RestrType(TRestr row)
    const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TRestr goblinGLPKWrapper::Index(TVar i)
    const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TRestr goblinGLPKWrapper::RowIndex(TRestr i)
    const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TVar goblinGLPKWrapper::RevIndex(TRestr i)
    const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetIndex(TRestr i,TVar j,TLowerUpper rt)
    throw(ERRange,ERRejected)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::SetRestrType(TRestr i,TLowerUpper rt)
    throw(ERRange,ERRejected)
{
    #if defined(_FAILSAVE_)
...
void goblinGLPKWrapper::ReleaseIndex()
    const throw()
{
    if (index)
    {
...
void goblinGLPKWrapper::InitIndex()
    const throw()
{
    if (index) return;
...
void goblinGLPKWrapper::InitBasis() const throw()
{
    lpx_std_basis(lp);
...
void goblinGLPKWrapper::EvaluateBasis() throw(ERRejected)
{
    lpx_warm_up(lp);
...
TFloat goblinGLPKWrapper::X(TVar var) const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TFloat goblinGLPKWrapper::Y(TRestr row,TLowerUpper loUp) const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TIndex goblinGLPKWrapper::TableauRow(TIndex k,TIndex* index,double* val)
    const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TIndex goblinGLPKWrapper::TableauColumn(TIndex k,TIndex* index,double* val)
    const throw(ERRange)
{
    #if defined(_FAILSAVE_)
...
TFloat goblinGLPKWrapper::Tableau(TIndex j,TIndex i) const throw(ERRange,ERRejected)
{
    #if defined(_FAILSAVE_)
...
TFloat goblinGLPKWrapper::BaseInverse(TIndex j,TIndex i)
...
void goblinGLPKWrapper::Pivot(TIndex j,TIndex i,TLowerUpper rt)
    throw(ERRange,ERRejected)
{
    #if defined(_FAILSAVE_)
...
TIndex goblinGLPKWrapper::TransformRow(TIndex len,TIndex* index,double* val)
{
...
void goblinGLPKWrapper::ResetParameters()
{
    lpx_reset_parms(lp);
}


void goblinGLPKWrapper::SetIntegerParameter(int parameter,int value)
{
    lpx_set_int_parm(lp,parameter,value);
}


void goblinGLPKWrapper::SetRealParameter(int parameter ,double value)
{
   lpx_set_real_parm(lp,parameter,value);
}


int goblinGLPKWrapper::GetIntegerParameter(int parameter)
{
    return lpx_get_int_parm(lp,parameter);
}


double goblinGLPKWrapper::GetRealParameter(int parameter)
{
...
TFloat goblinGLPKWrapper::SolveLP() throw(ERRejected)
{
    LogEntry(LOG_METH,"Calling GLPK plugin...");
    OpenFold(ModGLPK);
...
TFloat goblinGLPKWrapper::SolveMIP() throw(ERRejected)
{
    return goblinILPWrapper::SolveMIP();
    ...
    {
        CloseFold(ModGLPK);
        LogEntry(LOG_RES,"...LP relaxation is infeasible");
        return InfFloat;
    }
